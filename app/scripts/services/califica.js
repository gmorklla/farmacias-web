	...
	.service('Califica', ['$http', function($http) {
		return {
			postCalificacion: function(calificaId, votacion, calificaComentario) {
				return $http.post('http://www.farmaciasdesimilares.com.mx/WSAjax/MXFSWEBAJAXService.asmx/CalificacionComentarioPorId', "{'id':'" + calificaId + "','votacion':'" + votacion + "','comentario':'" + calificaComentario + "'}");
			}
		};
	}]);