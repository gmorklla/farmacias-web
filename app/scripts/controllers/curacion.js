...
angular.module('farmaciasWebApp')
    .controller('CuracionCtrl', ['LoadCuraSrv', 'prettyUrlSpc', 'productoSrv', 'CarritoSrv', 'LoadPromoSrv', 'PromoOrComboSrv', '$scope', '$rootScope', '$stateParams', '$log', function(LoadCuraSrv, prettyUrlSpc, productoSrv, CarritoSrv, LoadPromoSrv, PromoOrComboSrv, $scope, $rootScope, $stateParams, $log) {
        ...
        //console.log(LoadCuraSrv.httpReq());
        $scope.meds = [];
        $scope.cuantos = 9;
        ...
        $scope.getMeds = function(cuantos, page) {
            ...
            var medicamentos = LoadCuraSrv.httpReq(cuantos, page);
        ...
        if ($rootScope.prevState === 'curacion.detalle') {
