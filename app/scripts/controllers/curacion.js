...
angular.module('farmaciasWebApp')
  .controller('CuracionCtrl', ['LoadCuraSrv', 'prettyUrlSpc', 'productoSrv', 'CarritoSrv', '$scope', '$rootScope', '$stateParams', function (LoadCuraSrv, prettyUrlSpc, productoSrv, CarritoSrv, $scope, $rootScope, $stateParams) {
